...
export default function CategoriasScreen() {
  ...
  const styles = useMemo(() => StyleSheet.create(scaledSheet({
    ...
    catCellIcon: { width: 52, height: 52, borderRadius: 26, alignItems: 'center', justifyContent: 'center', marginBottom: SPACING.sm },
    catCellName: { color: COLORS.textMuted, fontSize: 11, fontWeight: '600', textAlign: 'center', marginBottom: SPACING.xs },
    catCellAmt: { fontSize: FONT.sm, fontWeight: '800', textAlign: 'center' },
    catCellBadge: { position: 'absolute', top: 6, right: 6, width: 16, height: 16, borderRadius: RADIUS.sm, backgroundColor: COLORS.warning, alignItems: 'center', justifyContent: 'center' },
    catList: { gap: SPACING.sm },
    catListRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.card, borderRadius: 14, padding: SPACING.md, borderWidth: 1.5, borderColor: COLORS.border },
    catListIcon: { width: 40, height: 40, borderRadius: RADIUS.md, alignItems: 'center', justifyContent: 'center', marginRight: SPACING.md, flexShrink: 0 },
    catListBody: { flex: 1 },
    catListTopRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 5 },
    catListName: { color: COLORS.text, fontSize: FONT.base, fontWeight: '700', flex: 1, marginRight: SPACING.sm },
    ...
    actHandle: { width: 40, height: 4, backgroundColor: COLORS.border, borderRadius: 2, alignSelf: 'center', marginBottom: SPACING.lg },
    actTitle: { color: COLORS.text, fontWeight: '800', fontSize: FONT.lg, marginBottom: SPACING.lg },
    actRow: { flexDirection: 'row', alignItems: 'center', gap: SPACING.md, paddingVertical: 14, borderTopWidth: 1, borderTopColor: COLORS.border },
