...
export default function TarjetasScreen() {
  ...
  const styles = useMemo(() => StyleSheet.create(scaledSheet({
    ...
    header: { paddingHorizontal: SPACING.xl, paddingTop: SPACING.xl, paddingBottom: SPACING.md, backgroundColor: COLORS.bg },
    ...
    subTabBar: {
      ...
      backgroundColor: COLORS.card, borderRadius: 14, padding: SPACING.xs,
    ...
    sectionDivider: {
      ...
      marginHorizontal: SPACING.lg, marginTop: SPACING.xxl, marginBottom: 14,
  ...
  const actStyles = useMemo(() => StyleSheet.create({
    ...
    preview: {
      marginHorizontal: SPACING.xl, marginTop: SPACING.lg, borderRadius: 18, padding: 18, height: 92,
    ...
    statsRow: { flexDirection: 'row', gap: SPACING.sm, marginHorizontal: SPACING.xl, marginTop: SPACING.md, marginBottom: 6 },
    statBox: {
    ...
    histSection: { marginHorizontal: SPACING.xl, marginBottom: SPACING.xs },
    histTitle: {
    ...
    optionsRow: { flexDirection: 'row', gap: 10, marginHorizontal: SPACING.xl, marginTop: SPACING.xs },
    optBtn: {
    ...
    addMoneyBtn: {
      ...
      marginHorizontal: SPACING.xl, marginTop: 10, paddingVertical: SPACING.lg, borderRadius: RADIUS.lg,
    },
    addMoneyBtnText: { color: '#fff', fontWeight: '700', fontSize: FONT.md },
    backBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, marginHorizontal: SPACING.xl, marginTop: SPACING.lg, marginBottom: SPACING.xs },
    backBtnText: { color: COLORS.textMuted, fontWeight: '600', fontSize: FONT.sm },
    moneyTitle: { color: COLORS.text, fontWeight: '800', fontSize: FONT.lg, marginHorizontal: SPACING.xl, marginTop: 6 },
    moneyInput: {
      backgroundColor: COLORS.bg, borderRadius: 14, padding: SPACING.lg,
      color: COLORS.text, fontSize: FONT.xxl, fontWeight: '700',
      borderWidth: 1.5, borderColor: COLORS.border,
      marginHorizontal: SPACING.xl, marginTop: SPACING.lg, textAlign: 'center',
    },
    noteInput: {
    ...
    confirmBtn: { marginHorizontal: SPACING.xl, marginTop: 14, paddingVertical: SPACING.lg, borderRadius: RADIUS.lg, alignItems: 'center' },
    confirmBtnText: { color: '#fff', fontWeight: '700', fontSize: FONT.md },
    debtModalTitle: { color: COLORS.text, fontWeight: '800', fontSize: FONT.lg, marginHorizontal: SPACING.xl, marginTop: SPACING.md, marginBottom: 2 },
    debtModalTotal: { color: COLORS.textMuted, fontSize: FONT.sm, marginHorizontal: SPACING.xl, marginBottom: SPACING.md },
    ...
    overflowIcon: {
      ...
      backgroundColor: COLORS.danger + '18', alignItems: 'center', justifyContent: 'center', marginBottom: SPACING.lg,
    },
    overflowTitle: { color: COLORS.text, fontWeight: '800', fontSize: FONT.lg, marginBottom: SPACING.sm, textAlign: 'center' },
    ...
    overflowDivider: { width: '100%', height: 1, backgroundColor: COLORS.border, marginVertical: SPACING.md },
  ...
  const expStyles = useMemo(() => StyleSheet.create({
    ...
    sheet: { backgroundColor: COLORS.card, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: SPACING.xl },
    handle: { width: 40, height: 4, backgroundColor: COLORS.border, borderRadius: 2, alignSelf: 'center', marginBottom: SPACING.lg },
    title: { color: COLORS.text, fontWeight: '700', fontSize: FONT.lg, marginBottom: SPACING.xs },
