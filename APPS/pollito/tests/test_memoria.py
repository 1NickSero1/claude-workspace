"""Pruebas de skills/memoria.py - proteccion contra path traversal y contra
borrar la carpeta raiz de memoria de una skill.
...
from skills.memoria import _borrar, _crear, _resolver_ruta_segura, _ver
